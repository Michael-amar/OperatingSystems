...
int main()
{
   ...
   e:	7fe50513          	addi	a0,a0,2046 # 808 <malloc+0xe6>
  12:	00000097          	auipc	ra,0x0
  16:	652080e7          	jalr	1618(ra) # 664 <printf>

    char* a =(char*) malloc(102400);
  1a:	6565                	lui	a0,0x19
  1c:	00000097          	auipc	ra,0x0
  20:	706080e7          	jalr	1798(ra) # 722 <malloc>
  24:	84aa                	mv	s1,a0
    a[0] = '3';
  26:	03300793          	li	a5,51
  2a:	00f50023          	sb	a5,0(a0) # 19000 <__global_pointer$+0x17fc7>
    for (int i=1; i<102400 ; i++)
  2e:	00150793          	addi	a5,a0,1
  32:	6765                	lui	a4,0x19
  34:	972a                	add	a4,a4,a0
         a[i] = '1';
  36:	03100693          	li	a3,49
  3a:	00d78023          	sb	a3,0(a5)
    for (int i=1; i<102400 ; i++)
  ...
  48:	298080e7          	jalr	664(ra) # 2dc <fork>
    if (pid == 0)
  4c:	c511                	beqz	a0,58 <main+0x58>
        ppages();
    }
    else {
        //printf("%c\n",a[0]);
  ...
  54:	294080e7          	jalr	660(ra) # 2e4 <exit>
        printf("child: %c\n",a[0]);
  58:	0004c583          	lbu	a1,0(s1)
  5c:	00000517          	auipc	a0,0x0
  60:	7b450513          	addi	a0,a0,1972 # 810 <malloc+0xee>
  64:	00000097          	auipc	ra,0x0
  68:	600080e7          	jalr	1536(ra) # 664 <printf>
        ppages();
  6c:	00000097          	auipc	ra,0x0
  70:	318080e7          	jalr	792(ra) # 384 <ppages>
  74:	bfe9                	j	4e <main+0x4e>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 252:	fed70fa3          	sb	a3,-1(a4) # 18fff <__global_pointer$+0x17fc6>
    while(n-- > 0)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	45850513          	addi	a0,a0,1112 # 828 <digits>
 3d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a0:	38cb8b93          	addi	s7,s7,908 # 828 <digits>
 ...
 5e0:	24490913          	addi	s2,s2,580 # 820 <malloc+0xfe>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a8:	19c7b783          	ld	a5,412(a5) # 840 <freep>
 ...
 6d6:	00e6ea63          	bltu	a3,a4,6ea <free+0x50>
{
 ...
 718:	12f73623          	sd	a5,300(a4) # 840 <freep>
}
 71c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 74a:	0fa53503          	ld	a0,250(a0) # 840 <freep>
 ...
 772:	0d290913          	addi	s2,s2,210 # 840 <freep>
  if(p == (char*)-1)
 776:	5afd                	li	s5,-1
 778:	a895                	j	7ec <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 77a:	00000797          	auipc	a5,0x0
 77e:	0ce78793          	addi	a5,a5,206 # 848 <base>
 782:	00000717          	auipc	a4,0x0
 786:	0af73f23          	sd	a5,190(a4) # 840 <freep>
 78a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ae:	08a73b23          	sd	a0,150(a4) # 840 <freep>
      return (void*)(p + 1);
 ...
 7fc:	b74080e7          	jalr	-1164(ra) # 36c <sbrk>
  if(p == (char*)-1)
