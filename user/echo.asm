...
main(int argc, char *argv[])
{
  ...
  2e:	876a0a13          	addi	s4,s4,-1930 # 8a0 <malloc+0xec>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	84058593          	addi	a1,a1,-1984 # 8a8 <malloc+0xf4>
  70:	4505                	li	a0,1
...
00000000000003ec <csem_alloc>:
.global csem_alloc
csem_alloc:
 li a7, SYS_csem_alloc
 3ec:	02100893          	li	a7,33
 ecall
 3f0:	00000073          	ecall
 ret
 3f4:	8082                	ret

00000000000003f6 <csem_free>:
.global csem_free
csem_free:
 li a7, SYS_csem_free
 3f6:	02200893          	li	a7,34
 ecall
 3fa:	00000073          	ecall
 ret
 3fe:	8082                	ret

0000000000000400 <csem_down>:
.global csem_down
csem_down:
 li a7, SYS_csem_down
 400:	02300893          	li	a7,35
 ecall
 404:	00000073          	ecall
 ret
 408:	8082                	ret

000000000000040a <csem_up>:
.global csem_up
csem_up:
 li a7, SYS_csem_up
...
0000000000000414 <print_ptable>:
.global print_ptable
print_ptable:
 li a7, SYS_print_ptable
 414:	02500893          	li	a7,37
 ecall
 418:	00000073          	ecall
 ret
 41c:	8082                	ret
...
putc(int fd, char c)
{
 ...
 434:	ee2080e7          	jalr	-286(ra) # 312 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 466:	45650513          	addi	a0,a0,1110 # 8b8 <digits>
 46a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 532:	38ab8b93          	addi	s7,s7,906 # 8b8 <digits>
 ...
 672:	24290913          	addi	s2,s2,578 # 8b0 <malloc+0xfc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 73a:	19a7b783          	ld	a5,410(a5) # 8d0 <freep>
 ...
 768:	00e6ea63          	bltu	a3,a4,77c <free+0x50>
{
 ...
 7aa:	12f73523          	sd	a5,298(a4) # 8d0 <freep>
}
 7ae:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7dc:	0f853503          	ld	a0,248(a0) # 8d0 <freep>
 ...
 804:	0d090913          	addi	s2,s2,208 # 8d0 <freep>
  if(p == (char*)-1)
 808:	5afd                	li	s5,-1
 80a:	a895                	j	87e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 80c:	00000797          	auipc	a5,0x0
 810:	0cc78793          	addi	a5,a5,204 # 8d8 <base>
 814:	00000717          	auipc	a4,0x0
 818:	0af73e23          	sd	a5,188(a4) # 8d0 <freep>
 81c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 840:	08a73a23          	sd	a0,148(a4) # 8d0 <freep>
      return (void*)(p + 1);
 ...
 88e:	af0080e7          	jalr	-1296(ra) # 37a <sbrk>
  if(p == (char*)-1)
