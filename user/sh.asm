...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3bc70713          	addi	a4,a4,956 # 1480 <malloc+0x1fc>
    ...
    panic("runcmd");
      ...
      e2:	2aa50513          	addi	a0,a0,682 # 1388 <malloc+0x104>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	29058593          	addi	a1,a1,656 # 1390 <malloc+0x10c>
     108:	4509                	li	a0,2
     10a:	00001097          	auipc	ra,0x1
     10e:	08e080e7          	jalr	142(ra) # 1198 <fprintf>
  exit(0);
     112:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     150:	25458593          	addi	a1,a1,596 # 13a0 <malloc+0x11c>
     154:	4509                	li	a0,2
     156:	00001097          	auipc	ra,0x1
     15a:	042080e7          	jalr	66(ra) # 1198 <fprintf>
      exit(1);
     15e:	4505                	li	a0,1
    ...
    break;
     ...
     1e6:	1ce50513          	addi	a0,a0,462 # 13b0 <malloc+0x12c>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	000080e7          	jalr	ra # 1284 <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	fb6080e7          	jalr	-74(ra) # 1284 <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	f5c080e7          	jalr	-164(ra) # 1284 <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	f16080e7          	jalr	-234(ra) # 1284 <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	ed4080e7          	jalr	-300(ra) # 1284 <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e36b8b93          	addi	s7,s7,-458 # 13d8 <malloc+0x154>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	e0450513          	addi	a0,a0,-508 # 13b8 <malloc+0x134>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d4460613          	addi	a2,a2,-700 # 13e0 <malloc+0x15c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d34b0b13          	addi	s6,s6,-716 # 1400 <malloc+0x17c>
  ...
  return ret;
     ...
     70a:	ce250513          	addi	a0,a0,-798 # 13e8 <malloc+0x164>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c8850513          	addi	a0,a0,-888 # 13f0 <malloc+0x16c>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c6660613          	addi	a2,a2,-922 # 1408 <malloc+0x184>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	bfea0a13          	addi	s4,s4,-1026 # 1410 <malloc+0x18c>
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	bd060613          	addi	a2,a2,-1072 # 1418 <malloc+0x194>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b3260613          	addi	a2,a2,-1230 # 13e0 <malloc+0x15c>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b5260613          	addi	a2,a2,-1198 # 1430 <malloc+0x1ac>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	b0050513          	addi	a0,a0,-1280 # 1420 <malloc+0x19c>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	b0850513          	addi	a0,a0,-1272 # 1438 <malloc+0x1b4>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b3c70713          	addi	a4,a4,-1220 # 1498 <malloc+0x214>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a4860613          	addi	a2,a2,-1464 # 1450 <malloc+0x1cc>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	a1a58593          	addi	a1,a1,-1510 # 1458 <malloc+0x1d4>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	750080e7          	jalr	1872(ra) # 1198 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	99850513          	addi	a0,a0,-1640 # 13e8 <malloc+0x164>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9f648493          	addi	s1,s1,-1546 # 1468 <malloc+0x1e4>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a5048493          	addi	s1,s1,-1456 # 14e8 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a43a0a13          	addi	s4,s4,-1469 # 14eb <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	9c0a8a93          	addi	s5,s5,-1600 # 1470 <malloc+0x1ec>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2c:	670080e7          	jalr	1648(ra) # 1198 <fprintf>
     b30:	bf79                	j	ace <main+0x6e>
      runcmd(parsecmd(buf));
     b32:	00001517          	auipc	a0,0x1
     b36:	9b650513          	addi	a0,a0,-1610 # 14e8 <buf.0>
...
0000000000000ebc <csem_alloc>:
.global csem_alloc
csem_alloc:
 li a7, SYS_csem_alloc
     ebc:	02100893          	li	a7,33
 ecall
     ec0:	00000073          	ecall
 ret
     ec4:	8082                	ret

0000000000000ec6 <csem_free>:
.global csem_free
csem_free:
 li a7, SYS_csem_free
     ec6:	02200893          	li	a7,34
 ecall
     eca:	00000073          	ecall
 ret
     ece:	8082                	ret

0000000000000ed0 <csem_down>:
.global csem_down
csem_down:
 li a7, SYS_csem_down
     ed0:	02300893          	li	a7,35
 ecall
     ed4:	00000073          	ecall
 ret
     ed8:	8082                	ret

0000000000000eda <csem_up>:
.global csem_up
csem_up:
 li a7, SYS_csem_up
     eda:	02400893          	li	a7,36
 ecall
     ede:	00000073          	ecall
 ret
     ee2:	8082                	ret

0000000000000ee4 <print_ptable>:
.global print_ptable
print_ptable:
 li a7, SYS_print_ptable
     ee4:	02500893          	li	a7,37
 ecall
     ee8:	00000073          	ecall
 ret
     eec:	8082                	ret
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f04:	ee2080e7          	jalr	-286(ra) # de2 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f36:	58650513          	addi	a0,a0,1414 # 14b8 <digits>
     f3a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1002:	4bab8b93          	addi	s7,s7,1210 # 14b8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1142:	37290913          	addi	s2,s2,882 # 14b0 <malloc+0x22c>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    120a:	2da7b783          	ld	a5,730(a5) # 14e0 <freep>
    ...
    1238:	00e6ea63          	bltu	a3,a4,124c <free+0x50>
{
  ...
  freep = p;
    ...
    127a:	26f73523          	sd	a5,618(a4) # 14e0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12ac:	23853503          	ld	a0,568(a0) # 14e0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12d4:	21090913          	addi	s2,s2,528 # 14e0 <freep>
  if(p == (char*)-1)
    12d8:	5afd                	li	s5,-1
    12da:	a895                	j	134e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12dc:	00000797          	auipc	a5,0x0
    12e0:	27478793          	addi	a5,a5,628 # 1550 <base>
    12e4:	00000717          	auipc	a4,0x0
    12e8:	1ef73e23          	sd	a5,508(a4) # 14e0 <freep>
    ...
    1310:	1ca73a23          	sd	a0,468(a4) # 14e0 <freep>
      return (void*)(p + 1);
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    135e:	af0080e7          	jalr	-1296(ra) # e4a <sbrk>
  if(p == (char*)-1)
