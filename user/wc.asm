...
main(int argc, char *argv[])
{
 ...
 188:	684080e7          	jalr	1668(ra) # 808 <printf>
      exit(1);
 18c:	4505                	li	a0,1
...
0000000000000512 <csem_down>:
.global csem_down
csem_down:
 li a7, SYS_csem_down
 512:	02300893          	li	a7,35
 ecall
 516:	00000073          	ecall
 ret
 51a:	8082                	ret

000000000000051c <csem_up>:
.global csem_up
csem_up:
 li a7, SYS_csem_up
 51c:	02400893          	li	a7,36
 ecall
 520:	00000073          	ecall
 ret
 524:	8082                	ret

0000000000000526 <print_ptable>:
.global print_ptable
print_ptable:
 li a7, SYS_print_ptable
 526:	02500893          	li	a7,37
 ecall
 52a:	00000073          	ecall
 ret
 52e:	8082                	ret
...
putc(int fd, char c)
{
 ...
 546:	ee2080e7          	jalr	-286(ra) # 424 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 578:	48c50513          	addi	a0,a0,1164 # a00 <digits>
 57c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 644:	3c0b8b93          	addi	s7,s7,960 # a00 <digits>
 ...
 784:	27890913          	addi	s2,s2,632 # 9f8 <malloc+0x132>
        while(*s != 0){
...
free(void *ap)
{
 ...
 84c:	1d07b783          	ld	a5,464(a5) # a18 <freep>
 ...
 87a:	00e6ea63          	bltu	a3,a4,88e <free+0x50>
{
 ...
 8bc:	16f73023          	sd	a5,352(a4) # a18 <freep>
}
 8c0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8ee:	12e53503          	ld	a0,302(a0) # a18 <freep>
 ...
 916:	10690913          	addi	s2,s2,262 # a18 <freep>
  if(p == (char*)-1)
 91a:	5afd                	li	s5,-1
 91c:	a895                	j	990 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 91e:	00000797          	auipc	a5,0x0
 922:	30278793          	addi	a5,a5,770 # c20 <base>
 926:	00000717          	auipc	a4,0x0
 92a:	0ef73923          	sd	a5,242(a4) # a18 <freep>
 92e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 952:	0ca73523          	sd	a0,202(a4) # a18 <freep>
      return (void*)(p + 1);
 ...
 97e:	ec4080e7          	jalr	-316(ra) # 83e <free>
  return freep;
 ...
 9a0:	af0080e7          	jalr	-1296(ra) # 48c <sbrk>
  if(p == (char*)-1)
